...
- [ ] Update PR #25 so it removes the direct `pytest` pin and adds a regression test for the dependency policy.
...
- [ ] Run local validation for each updated branch and push it.
